...
if release_dir == "latest":
    # conf.py now lives at <repo_root>/docs/latest/source/conf.py (one
    # level shallower than when this was appcraft/docs/latest/source/
    # conf.py) — parents[3] is <repo_root>, not parents[4].
    pyproject_path = conf_path.parents[3] / "pyproject.toml"
