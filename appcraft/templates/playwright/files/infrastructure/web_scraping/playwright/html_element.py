...
class PlaywrightHTMLElement(HTMLInteractiveElementInterface):
    def __init__(
    ...
    @inner_html.setter
    def inner_html(self, value: str | Self):  # pyright: ignore[reportIncompatibleMethodOverride]
        self._page.evaluate(
    ...
    def append_child(  # pyright: ignore[reportIncompatibleMethodOverride]
        self, child: Self
    ):
        self._page.evaluate(
    ...
    def remove_child(  # pyright: ignore[reportIncompatibleMethodOverride]
        self, child: Self | int
    ):
