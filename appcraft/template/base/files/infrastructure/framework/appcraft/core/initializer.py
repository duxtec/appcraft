...
from infrastructure.framework.appcraft.core.error_handler\
    import ErrorHandler

from infrastructure.framework.appcraft.core.app_manager\
    import AppManager

from infrastructure.framework.appcraft.core.package_manager\
...
try:
    from infrastructure.framework.appcraft.utils.logger\
        import Logger
except Exception:
    import logging
...
class Initializer:
    ...
    def execute_runner(self):
        from infrastructure.framework.appcraft.core.runner\
            import Runner
        ...
        try:
            ...
            if os.path.exists(module_path):
                from infrastructure.framework.\
                    appcraft.utils.message_manager\
    ...
    def main(self):
        try:
            if self.package_manager.venv_is_active():
                self.execute_runner()
            else:
